...
echo [3.5/4] Configuring IIS Path (Fix 404 Error)...
%windir%\system32\inetsrv\appcmd.exe set vdir "Default Web Site/" /physicalPath:"C:\UnityApp\Unity_Final\backend"

echo [4/4] Starting IIS...
iisreset /start
