      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Ekibim</h1>
          </div>
          <p className="text-gray-600">Takım üyeleriniz ve performans istatistikleri</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Toplam Üye</h3>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Tamamlanan Görev</h3>
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900">Devam Eden</h3>
            </div>
            <p className="text-3xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6">Takım Üyeleri</h2>
            ...
            {users.map(user => {
              ...
              return (
                ...
                >
                  ...
                  {/* Role Badge */}
                  <div className="mb-4">
                    <span className={`inline-flex items-center gap-1 px-2 py-1 rounded-full text-xs font-semibold ${getRoleBadgeColor(user.role)}`}>
                      <Shield size={12} />
