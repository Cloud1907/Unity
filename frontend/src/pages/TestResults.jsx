        ...
        <div className="h-screen bg-gray-50 overflow-auto p-8">
            <div className="max-w-4xl mx-auto">
                <div className="mb-8 flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Otomasyon & Test Sonuçları</h1>
                        <p className="text-gray-600 mt-1">Playwright E2E ve Birim test sonuçlarının genel görünümü</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="text-sm text-gray-500 mb-1">Toplam Senaryo</div>
                        <div className="text-3xl font-bold text-gray-900">42</div>
                    </div>
                    <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        <div className="text-sm text-gray-500 mb-1">Ortalama Süre</div>
                        <div className="text-3xl font-bold text-blue-600">44s</div>
                    </div>
                </div>

                <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                        <h3 className="font-semibold text-gray-900 text-sm">Son Test Koşuları</h3>
                        ...
                        {tests.map(test => (
                            <div key={test.id} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50 transition-colors">
                                <div className="flex items-center gap-3">
                                    <div className={`p-2 rounded-lg ${test.status === 'passed' ? 'bg-green-50 text-green-600' : 'bg-red-50 text-red-600'}`}>
