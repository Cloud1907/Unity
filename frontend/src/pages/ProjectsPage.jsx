      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Tüm projelerinizi görüntüleyin ve yönetin</p>
          </div>
          ...
          {filteredProjects.map(project => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-xl p-6 shadow-sm border border-gray-200 hover:shadow-xl transition-all cursor-pointer group"
              >
                {/* Header */}
