    ...
    <div className="h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 overflow-auto">
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="mb-8 flex justify-between items-start">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">Ana Sayfa</h1>
            <p className="text-gray-600 dark:text-gray-400">Projeleriniz ve görevleriniz hakkında genel bakış</p>
          </div>
          <div className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-gray-200/50 dark:border-gray-700/50 flex items-center gap-2">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500"></span>
            </span>
            <span className="text-xs font-mono font-medium text-gray-500 dark:text-gray-400">v{pkg.version}</span>
          </div>
        </div>
          ...
          {stats.map((stat, index) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className={`${stat.bg} dark:bg-gray-700 p-3 rounded-lg`}>
                  {stat.icon}
                </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">Projelerim</h2>
            <button
