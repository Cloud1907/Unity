...
const MainTable = ({ boardId, searchQuery, filters }) => {
  ...
  const { fetchTasks, fetchLabels, updateTaskStatus, updateTask, deleteProject } = useDataActions();
      ...
      <div className="flex-1 overflow-auto bg-white dark:bg-[#0f172a] relative">
        ...
        <div className="min-w-max">
                    ...
                    <div className="w-28 px-3 py-3 border-r border-gray-100 dark:border-gray-800">
                      <div className="flex flex-col gap-1 w-full group/progress">
                        <div className="flex items-center justify-between">
                          <span className="text-[9px] font-semibold text-gray-500 dark:text-gray-400">{progress}%</span>
          ...
          <div
            ...
            className="flex hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors border-b border-gray-100 dark:border-gray-800 group cursor-pointer"
          >
            <div className="w-18 px-6 flex items-center justify-center py-2 border-r border-gray-100 dark:border-gray-800">
